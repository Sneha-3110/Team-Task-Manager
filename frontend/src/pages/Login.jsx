...
import { ArrowLeft, Eye, EyeClosed, LockKeyhole } from 'lucide-react';
      ...
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl md:grid-cols-[.95fr_1.05fr]">
        <aside className="hidden bg-slate-950 p-10 text-white md:block">
          ...
          <h1 className="text-4xl font-black leading-tight tracking-tight">
            Bring your task flow into focus.
          </h1>
          <p className="mt-5 leading-7 text-slate-300">
            Sign in to see your assigned work, update progress, and keep the team moving.
          </p>
          <div className="mt-10 rounded-xl border border-white/10 bg-white/[.06] p-5">
            <p className="text-sm font-semibold text-slate-300">Fast setup</p>
            <p className="mt-2 text-3xl font-black text-cyan-300">2 roles</p>
            <p className="mt-2 text-sm text-slate-400">Admin for assignment, Member for execution.</p>
          </div>
        </aside>
